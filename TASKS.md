...
| **T1.8** 🟡 | Growth: `logGrowth` (weight/height/head circ., metric/imperial), `getLatestGrowth`                                               | **DONE** — `src/client/growthOps.ts`; `logGrowth`, `getLatestGrowth`, `getGrowthHistory`, unit-tested         | Sonnet 4.6 |
