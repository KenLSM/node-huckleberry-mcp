...
| B6        | **API/Firestore discovery harness** — upgrade `inspect-schema` to a configurable multi-path prober (exists/empty/not-found + JSON output) and seed a living `docs/firestore-schema.md` catalog | Implements `docs/discovery-plan.md`. Mine candidate paths from the Python source + app UI; sweep them against a real account; record shapes + deviations. Underpins B5 and future features.                                                                                                                                                                                                                                                                                                                    | Sonnet 4.6 |
